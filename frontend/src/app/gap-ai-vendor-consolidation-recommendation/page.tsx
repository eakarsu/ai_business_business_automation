...
// v0 scaffold for: No AI vendor consolidation recommendation
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-ai-vendor-consolidation-recommendation/run.

export default function AiVendorConsolidationRecommendationPage() {
  ...
  async function run() {
    ...
    setResult(null);
    try {
      const res = await fetch('/api/gap-ai-vendor-consolidation-recommendation/run', {
        method: 'POST',
        credentials: 'include',
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No AI vendor consolidation recommendation</h1>
