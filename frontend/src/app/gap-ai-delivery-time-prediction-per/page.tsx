...
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-ai-delivery-time-prediction-per/run.

export default function AiDeliveryTimePredictionPerPage() {
  ...
  async function run() {
    ...
    setResult(null);
    try {
      const res = await fetch('/api/gap-ai-delivery-time-prediction-per/run', {
        method: 'POST',
        credentials: 'include',
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No AI delivery-time prediction per supplier</h1>
