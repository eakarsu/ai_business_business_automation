...
// v0 scaffold for: No e-signature workflow for contracts
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-e-signature-workflow-contracts/run.

export default function ESignatureWorkflowContractsPage() {
  ...
  async function run() {
    ...
    setResult(null);
    try {
      const res = await fetch('/api/gap-e-signature-workflow-contracts/run', {
        method: 'POST',
        credentials: 'include',
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No e-signature workflow for contracts</h1>
