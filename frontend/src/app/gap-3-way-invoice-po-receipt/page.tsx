...
// v0 scaffold for: No 3-way invoice-to-PO-to-receipt matching workflow
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-3-way-invoice-po-receipt/run.

export default function ThreeWayInvoicePoReceiptPage() {
  ...
  async function run() {
    ...
    setResult(null);
    try {
      const res = await fetch('/api/gap-3-way-invoice-po-receipt/run', {
        method: 'POST',
        credentials: 'include',
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No 3-way invoice-to-PO-to-receipt matching workflow</h1>
