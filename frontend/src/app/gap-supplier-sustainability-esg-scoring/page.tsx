...
// v0 scaffold for: No supplier sustainability / ESG scoring
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-supplier-sustainability-esg-scoring/run.

export default function SupplierSustainabilityEsgScoringPage() {
  ...
  async function run() {
    ...
    setResult(null);
    try {
      const res = await fetch('/api/gap-supplier-sustainability-esg-scoring/run', {
        method: 'POST',
        credentials: 'include',
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No supplier sustainability / ESG scoring</h1>
